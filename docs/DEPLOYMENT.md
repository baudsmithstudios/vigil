...
> **This is a developer reference.** It covers cross-compilation, buildx workflows, and Pi-specific troubleshooting. If you're setting up Vigil for the first time, the [README Quick Start](../README.md#quick-start) is the right place to begin.
